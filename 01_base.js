...
// 2 Мутирование
    ...
    // const firstName = prompt('Введите ваше имя: ') // Всплывающее окно, в которое пользователь может что-то писать
    // alert('Привет, ' + firstName)  // Простое всплывающее окно
    // confirm('Вам 19 лет?') // Всплывающее окно, в котором пользователь отвечает "да" или "нет"
    // prompt('Текст') // Всплывающее окно ввода данных
...
// 9 Массивы
    ...
    //     console.log(element)   // Метод forEach позволяет пробегаться по каждому элементу массива 
    // });
